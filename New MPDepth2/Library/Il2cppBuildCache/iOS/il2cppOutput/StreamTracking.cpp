...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void StreamTrackingCalibrator_CalculateCalibrationFromTrackingInfo_m60CC17C8F9456CD34A69D360D24B3EB83F31939C (StreamTrackingCalibrator_tD383986F1D0BC99C954A4DAE69E3A7A98642812C * __this, const RuntimeMethod* method)
{
	...
	memset((&V_6), 0, sizeof(V_6));
	{
		...
		L_30 = Vector3_op_Multiply_m079B29E4F58127F03BD52558C1FE1A528547328F_inline((-1.0f), L_29, /*hidden argument*/NULL);
		NullCheck(L_20);
		Transform_set_eulerAngles_mFDCBC6282E4B1196AA26BF01008B2AAA2DD2969E(L_20, L_30, /*hidden argument*/NULL);
		// tempFace.name = "tempFace";
		GameObject_tC000A2E1A7CF1E10FD7BA08863287C072207C319 * L_31 = V_1;
		NullCheck(L_31);
		Object_set_name_m87C4006618ADB325ABE5439DF159E10DD8DD0781(L_31, _stringLiteral486B66E7C5A80B862FB8B09AD92A68207CDDA2AD, /*hidden argument*/NULL);
		// GameObject tempOffset = new GameObject();
		GameObject_tC000A2E1A7CF1E10FD7BA08863287C072207C319 * L_32 = (GameObject_tC000A2E1A7CF1E10FD7BA08863287C072207C319 *)il2cpp_codegen_object_new(GameObject_tC000A2E1A7CF1E10FD7BA08863287C072207C319_il2cpp_TypeInfo_var);
		GameObject__ctor_mACDBD7A1F25B33D006A60F67EF901B33DD3D52E9(L_32, /*hidden argument*/NULL);
		V_3 = L_32;
		...
		NullCheck(L_34);
		Transform_set_parent_mEAE304E1A804E8B83054CEECB5BF1E517196EC13(L_34, L_36, /*hidden argument*/NULL);
		// tempOffset.name = "tempOffset";
		GameObject_tC000A2E1A7CF1E10FD7BA08863287C072207C319 * L_37 = V_3;
		NullCheck(L_37);
		Object_set_name_m87C4006618ADB325ABE5439DF159E10DD8DD0781(L_37, _stringLiteral77917F65152BFCCFCED5473A1BCB1188F7DC422E, /*hidden argument*/NULL);
		// Vector3 flippedPos = -trackingData.CameraTrackingData.Position;
		MPDepthTrackingData_t1C4585927FA6400A61AC93F18B144C0BE8C3F1F7 * L_38 = __this->get_trackingData_9();
		NullCheck(L_38);
		CameraTrackingData_tAAE8DCC63B02088F63C7D759E4FCF8A268374FCE * L_39 = L_38->get_CameraTrackingData_1();
		NullCheck(L_39);
		Vector3_t65B972D6A585A0A5B63153CF1177A90D3C90D65E  L_40 = ((TrackingPose_t9D6C81FDF981E08EBF7CDBBB363CA99CAB3EC265 *)L_39)->get_Position_0();
		Vector3_t65B972D6A585A0A5B63153CF1177A90D3C90D65E  L_41;
		L_41 = Vector3_op_UnaryNegation_m362EA356F4CADEDB39F965A0DBDED6EA890925F7_inline(L_40, /*hidden argument*/NULL);
		V_4 = L_41;
		...
		Vector3__ctor_m57495F692C6CE1CEF278CAD9A98221165D37E636_inline((&L_50), ((-L_45)), L_47, L_49, /*hidden argument*/NULL);
		NullCheck(L_43);
		Transform_set_localPosition_m2A2B0033EF079077FAE7C65196078EAF5D041AFC(L_43, L_50, /*hidden argument*/NULL);
		// tempOffset.transform.localEulerAngles = Vector3.zero;
		GameObject_tC000A2E1A7CF1E10FD7BA08863287C072207C319 * L_51 = V_3;
		NullCheck(L_51);
		...
		L_53 = Vector3_get_zero_m1A8F7993167785F750B6B01762D22C2597C84EF6(/*hidden argument*/NULL);
		NullCheck(L_52);
		Transform_set_localEulerAngles_mB63076996124DC76E6902A81677A6E3C814C693B(L_52, L_53, /*hidden argument*/NULL);
		// calibrationTransform.position = tempOffset.transform.position;
		Transform_tA8193BB29D4D2C7EC04918F3ED1816345186C3F1 * L_54 = __this->get_calibrationTransform_13();
		GameObject_tC000A2E1A7CF1E10FD7BA08863287C072207C319 * L_55 = V_3;
		NullCheck(L_55);
		...
		Transform_tA8193BB29D4D2C7EC04918F3ED1816345186C3F1 * L_58 = __this->get_calibrationTransform_13();
		...
		NullCheck(L_58);
		Transform_set_rotation_m1B5F3D4CE984AB31254615C9C71B0E54978583B4(L_58, L_61, /*hidden argument*/NULL);
		// Destroy(tempFace);
		GameObject_tC000A2E1A7CF1E10FD7BA08863287C072207C319 * L_62 = V_1;
		...
		SavedStreamTrackingConfiguration_t882125EB1ACDF69F4BA69766647717A440F267AF * L_63 = (SavedStreamTrackingConfiguration_t882125EB1ACDF69F4BA69766647717A440F267AF *)il2cpp_codegen_object_new(SavedStreamTrackingConfiguration_t882125EB1ACDF69F4BA69766647717A440F267AF_il2cpp_TypeInfo_var);
		SavedStreamTrackingConfiguration__ctor_m72339F8AE71C40B33AA10DD430B6CBEF8ABC616A(L_63, /*hidden argument*/NULL);
		__this->set_calibration_11(L_63);
		// calibration.name = System.DateTime.Now.ToString();
		SavedStreamTrackingConfiguration_t882125EB1ACDF69F4BA69766647717A440F267AF * L_64 = __this->get_calibration_11();
		...
		V_5 = L_65;
		String_t* L_66;
		L_66 = DateTime_ToString_m242888E500DFD8CD675BDC455BC696AF47813954((DateTime_tEAF2CD16E071DF5441F40822E4CFE880E5245405 *)(&V_5), /*hidden argument*/NULL);
		NullCheck(L_64);
		L_64->set_name_0(L_66);
		// calibration.TrackerOffsetCalibration.Position = calibrationTransform.position;
		SavedStreamTrackingConfiguration_t882125EB1ACDF69F4BA69766647717A440F267AF * L_67 = __this->get_calibration_11();
		NullCheck(L_67);
		TrackerOffsetCalibration_tD2EC555FBB1EF1E2A33767B5EF260584742C3321 * L_68 = L_67->get_TrackerOffsetCalibration_1();
		Transform_tA8193BB29D4D2C7EC04918F3ED1816345186C3F1 * L_69 = __this->get_calibrationTransform_13();
		NullCheck(L_69);
		...
		NullCheck(L_68);
		((TrackingPose_t9D6C81FDF981E08EBF7CDBBB363CA99CAB3EC265 *)L_68)->set_Position_0(L_70);
		// calibration.TrackerOffsetCalibration.Eulers = calibrationTransform.rotation.eulerAngles;
		SavedStreamTrackingConfiguration_t882125EB1ACDF69F4BA69766647717A440F267AF * L_71 = __this->get_calibration_11();
		NullCheck(L_71);
		TrackerOffsetCalibration_tD2EC555FBB1EF1E2A33767B5EF260584742C3321 * L_72 = L_71->get_TrackerOffsetCalibration_1();
		Transform_tA8193BB29D4D2C7EC04918F3ED1816345186C3F1 * L_73 = __this->get_calibrationTransform_13();
		NullCheck(L_73);
		Quaternion_t6D28618CF65156D4A0AD747370DDFD0C514A31B4  L_74;
		L_74 = Transform_get_rotation_m4AA3858C00DF4C9614B80352558C4C37D08D2200(L_73, /*hidden argument*/NULL);
		V_6 = L_74;
		Vector3_t65B972D6A585A0A5B63153CF1177A90D3C90D65E  L_75;
		L_75 = Quaternion_get_eulerAngles_m3DA616CAD670235A407E8A7A75925AA8E22338C3((Quaternion_t6D28618CF65156D4A0AD747370DDFD0C514A31B4 *)(&V_6), /*hidden argument*/NULL);
		NullCheck(L_72);
		((TrackingPose_t9D6C81FDF981E08EBF7CDBBB363CA99CAB3EC265 *)L_72)->set_Eulers_1(L_75);
		// GetComponent<StreamTrackingProvider>().SaveCalibration(calibration);
		StreamTrackingProvider_t6B2C21DF1BCB6AEE131C01422B53D03B99276667 * L_76;
		L_76 = Component_GetComponent_TisStreamTrackingProvider_t6B2C21DF1BCB6AEE131C01422B53D03B99276667_m1F8FDC3667013B96EFDC6EBBA8954F390FB67F86(__this, /*hidden argument*/Component_GetComponent_TisStreamTrackingProvider_t6B2C21DF1BCB6AEE131C01422B53D03B99276667_m1F8FDC3667013B96EFDC6EBBA8954F390FB67F86_RuntimeMethod_var);
		SavedStreamTrackingConfiguration_t882125EB1ACDF69F4BA69766647717A440F267AF * L_77 = __this->get_calibration_11();
		NullCheck(L_76);
		StreamTrackingProvider_SaveCalibration_m7800F133B98FA3986D8063EE054DD56C739A5294(L_76, L_77, /*hidden argument*/NULL);
		// }
		return;
	}
}

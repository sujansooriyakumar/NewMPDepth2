...
IL_0010:
	...
	}
	{
		...
		Debug_LogError_m8850D65592770A364D494025FF3A73E8D4D70485(_stringLiteralE3AC59A40D687CA8AD4CF9FF120C62CCB231056D, /*hidden argument*/NULL);
		goto IL_0060;
	}
...
IL_0030:
	{
		...
		V_3 = (bool)((((RuntimeObject*)(DownloadHandler_tEEAE0DD53DB497C8A491C4F7B7A14C3CA027B1DB *)L_7) == ((RuntimeObject*)(RuntimeObject *)NULL))? 1 : 0);
		bool L_8 = V_3;
		if (!L_8)
		{
			goto IL_0052;
	...
	{
		IL2CPP_RUNTIME_CLASS_INIT(Debug_tEB68BCBEB8EFD60F8043C67146DC05E7F50F374B_il2cpp_TypeInfo_var);
		Debug_LogError_m8850D65592770A364D494025FF3A73E8D4D70485(_stringLiteral6652A4EEEFE1AE58E7CF235818DAD3A44193F05F, /*hidden argument*/NULL);
		goto IL_0060;
	}
...
IL_0052:
	{
		...
		DownloadHandler_tEEAE0DD53DB497C8A491C4F7B7A14C3CA027B1DB * L_10 = V_0;
		NullCheck(L_10);
		ByteU5BU5D_tDBBEB0E8362242FA7223000D978B0DD19D4B0726* L_11;
		L_11 = DownloadHandler_get_data_m3AE551AAE6BF21279435D386E76EA7084CC037D3(L_10, /*hidden argument*/NULL);
		bool L_12;
		L_12 = ImageConversion_LoadImage_m1E5C9BF6206ED40B23CDB28341B8A64E05C43683(L_9, L_11, (bool)0, /*hidden argument*/NULL);
	}

...
{
    public static class NatNetConstants
    {
        ...
        public const int MaxRigidBodyMarkers = 20;
    ...
    public enum NatNetConnectionType
    {
    ...
    public struct MarkerDataVector
    {
    ...
    [StructLayout( LayoutKind.Sequential, CharSet = CharSet.Ansi )]
    public struct sRigidBodyDescription
    {
        [MarshalAs( UnmanagedType.ByValTStr, SizeConst = NatNetConstants.MaxNameLength )]
        public string Name;
    ...
    [StructLayout( LayoutKind.Sequential, CharSet = CharSet.Ansi )]
    public struct sSkeletonDescription
    {
        [MarshalAs( UnmanagedType.ByValTStr, SizeConst = NatNetConstants.MaxNameLength )]
        public string Name;
    ...
    [StructLayout( LayoutKind.Sequential, CharSet = CharSet.Ansi )]
    public struct sForcePlateDescription
    {
        public Int32 Id;
    ...
    [StructLayout( LayoutKind.Sequential )]
    public struct sAnalogChannelData
    {
    ...
    [StructLayout( LayoutKind.Sequential, CharSet = CharSet.Ansi )]
    public struct sNatNetClientConnectParams
    {
    ...
    public delegate void NatNetFrameReceivedCallback( IntPtr pFrameOfMocapData, IntPtr pUserData );
    ...
    public static class NativeMethods
    {
        ...
        [DllImport( NatNetConstants.NatNetLibDllBaseName, CallingConvention = NatNetConstants.NatNetLibCallingConvention )]
        public static extern NatNetError NatNet_Frame_SecondsSinceHostTimestamp(IntPtr clientHandle, UInt64 inTimestamp, out double pOutTimeElapsed);
